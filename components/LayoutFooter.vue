  ...
  <footer id="footer" class="bg-gray-800">
    <div class="px-4 py-12 mx-auto overflow-hidden max-w-7xl sm:px-6 lg:px-8">
      <div class="mx-auto mb-10 text-center text-gray-300 sm:max-w-2xl">
        <logo class="mb-5" />
        <p>
          ظهرت الفكرة في عام ٢٠٢٠، في حين كانت تمر البشرية بجائحة عالمية،
          واستولت الأفكار السلبية على عقول العديد. ومن هنا وُجد تطبيق توكيدات
          ليساعدك على ممارسة التوكيدات بشكل يومي مستمر ليحررك من الأفكار السلبية
          المعرقلة لتطورك الذاتي ولتغيير نمط تفكيرك من السلبي إلى الإيجابي.
        </p>
      </div>
      <hr class="w-1/2 mx-auto mb-10 border-gray-600" />
      <nav
      ...
      <p class="mt-8 text-base text-center text-gray-200">
        &copy; ٢٠٢١ توكيدات. كل الحقوق محفوظة.
      </p>
    </div>
  </footer>
</template>